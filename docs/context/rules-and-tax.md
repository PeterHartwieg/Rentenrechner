...
| `src/rules/legalConstants.ts` | Cross-year structural constants: 1/120 SGB V spreading factor, §34 EStG Fünftelregelung divisor, §20 Abs. 1 Nr. 6 / §52 Abs. 28 age split by contract year, 12-year runtime threshold, halbeinkünfte factor 0.5, Soli rate 5.5 % and Milderungszone 11.9 % (`soli`), §39b PAP KV+PV+AV cap (`payrollTax.vorsorgepauschaleKvPvAvCap`), §1a BetrAVG divisor (`bav.minimumEntitlementDivisor`) | Only when underlying law changes, not on the annual cycle |
