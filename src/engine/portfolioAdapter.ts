...
// ProductSlot is local to projection helpers; transfer slot detection is in
// portfolioTransfer.detectProductSlot (re-exported above).
...
// AnyInstance and detectProductSlot are re-exported from portfolioTransfer for
// back-compat with callers that import them from portfolioAdapter.
