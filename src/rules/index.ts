 ...
 *      co-located provenance metadata block at the bottom of the file).
 ...
 * every result (`ruleSetId`, `ruleYear`, `calculationModel`) instead of
 * inventing their own versioning; see docs/rules-versioning.md for the
 * contract and its limits (an ID does not guarantee historical replay).
 */
