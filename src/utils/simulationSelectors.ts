...
//
// Canonical location: src/utils/simulationSelectors.ts
// (Moved from src/app/simulationSelectors.ts — engine/api must not import from src/app.)
