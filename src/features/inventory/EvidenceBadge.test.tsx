 ...
 *   - Clicking "Übernehmen" invokes onConfirm callback.
 */
...
describe('EvidenceBadge', () => {
  ...
  it('calls onConfirm when the confirm button is clicked', () => {
    ...
    const btn = screen.getByText(/Übernehmen/)
    fireEvent.click(btn)
  ...
  it('user_confirmed: .evidence-badge--confirmed class is present and "Übernehmen" button is absent', () => {
  ...
  it('model_estimate + onConfirm: clicking "Übernehmen" fires callback with no args', () => {
    const onConfirm = vi.fn()
    render(<EvidenceBadge state="model_estimate" onConfirm={onConfirm} />)
    const btn = screen.getByText(/Übernehmen/)
    fireEvent.click(btn)
  ...
  it('model_estimate WITHOUT onConfirm: "Übernehmen" button is absent (derived-display / Zulagen-Status case)', () => {
    const { container } = render(<EvidenceBadge state="model_estimate" />)
    expect(container.querySelector('.evidence-badge-confirm-btn')).toBeNull()
  })
})
