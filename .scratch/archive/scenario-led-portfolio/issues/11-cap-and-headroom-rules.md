...
Verified against the current repo on 2026-05-05: `recommendations.ts` contains the bAV, Basisrente, Riester, AVD, and Sparerpauschbetrag cap/headroom rules and registers them in `RULES`, with matching rule tests. This issue appears shipped; remaining Group G defects live under `.scratch/group-g-qa/issues/`.
