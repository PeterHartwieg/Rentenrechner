...
- [ ] Evidence and provenance states are mapped through one shared presentation vocabulary or clearly documented adapter layer.
- [ ] Inventory confidence labels, result confidence labels, recommendation confidence wording, and export wording use consistent concepts.
- [ ] German wording is reviewed by a human before merge.
- [ ] Estimated values remain visibly distinct from confirmed values.
- [ ] No evidence information is lost during display mapping.
- [ ] Tests cover confidence presentation for confirmed, estimated, statement-derived, and mixed-source result cases.
